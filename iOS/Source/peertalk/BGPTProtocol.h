...
// NSError domain
FOUNDATION_EXPORT NSString * const BGPTProtocolErrorDomain;


@interface BGPTProtocol : NSObject
...
@interface NSDictionary (BGPTProtocol)
// See description of -[NSData(BGPTProtocol) createReferencingDispatchData]
- (dispatch_data_t)createReferencingDispatchData;
@end
