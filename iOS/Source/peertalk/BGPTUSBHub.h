...
// already attached when the BGPTUSBHub starts listening.
//
//  .userInfo = {
//    DeviceID = 3;
...
typedef NSString * BGPTUSBHubNotificationKey NS_TYPED_ENUM;
FOUNDATION_EXPORT BGPTUSBHubNotificationKey const BGPTUSBHubNotificationKeyDeviceID NS_SWIFT_NAME(deviceID);
FOUNDATION_EXPORT BGPTUSBHubNotificationKey const BGPTUSBHubNotificationKeyMessageType NS_SWIFT_NAME(messageType);
FOUNDATION_EXPORT BGPTUSBHubNotificationKey const BGPTUSBHubNotificationKeyProperties NS_SWIFT_NAME(properties);

// NSError domain
FOUNDATION_EXPORT NSString * const BGPTUSBHubErrorDomain;

// Error codes returned with NSError.code for NSError domain BGPTUSBHubErrorDomain
typedef enum {
  BGPTUSBHubErrorBadDevice = 2,
  BGPTUSBHubErrorConnectionRefused = 3,
} BGPTUSBHubError;

@interface BGPTUSBHub : NSObject
